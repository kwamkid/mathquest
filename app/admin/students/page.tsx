    ...
    try {
      ...
      const usersData = usersSnapshot.docs.map(doc => {
        ...
        return {
          id: doc.id,
          ...data,
          // ตรวจสอบให้แน่ใจว่ามี avatar field
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-metaverse-darkPurple/50 border-b border-metaverse-purple/30">
                <th className="px-6 py-2 text-left text-sm font-semibold text-white/80">นักเรียน</th>
              ...
              {filteredStudents.length === 0 ? (
                ...
                filteredStudents.map((student) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-2 text-sm text-white/80">
                      {student.school}
                    </td>
